    ...
    public function me(Request $request)
    {
        ...
        try {
            ...
            if ($data['ok'] && isset($data['perfil'])) {
                $perfil = $data['perfil'];
                // Servir por /api/media para evitar depender del symlink storage en hosting compartido.
                if (!empty($perfil['foto_url'])) {
                    $perfil['foto_url'] = '/api/media/' . $perfil['foto_url'];
                }
