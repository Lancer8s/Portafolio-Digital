...
const MIGRATION_KEY_HASH = 'b781d39ec99c4d774bb66c4871557e99109dd30a84ac9fac0300e3ce8a3f2c62';
const MIGRATION_PATH = 'database/migrations/2026_06_20_010000_add_motivo_rechazo_ci_to_usuario_table.php';
...
$lockPath = __DIR__.'/../storage/app/motivo-rechazo-ci-migration-20260620.lock';
...
if ($exitCode === 0) {
    respond(
        ...
        $selfDeleted
            ? 'Se ejecutó únicamente la migración del motivo de rechazo de CI y el ejecutor se autoeliminó.'
            : 'Se ejecutó únicamente la migración del motivo de rechazo de CI. Elimina inmediatamente este archivo mediante FTP.',
        $artisanOutput
    );
}
