              ...
              <motion.div key={u.id_usuario} layout initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }}
                ...
                <div style={{ padding: 20, flex: 1 }}>
                  <div onClick={() => setSelectedUser(u)}
                    style={{ background: isDark ? "#1E293B" : "#F1F5F9", borderRadius: 12, height: 150, backgroundImage: `url(http://localhost:8000${u.ci_url})`, backgroundSize: "cover", backgroundPosition: "center", cursor: "pointer", border: `1px solid ${border}`, position: "relative" }}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.92 }} animate={{ scale: 1 }} exit={{ scale: 0.92 }}
              ...
              <div style={{ flex: 1, overflow: "auto", borderRadius: 12, border: `1px solid ${border}`, background: isDark ? "#000" : "#F8FAFC" }}>
                <img src={`http://localhost:8000${selectedUser.ci_url}`} alt="CI" style={{ width: "100%", height: "auto", display: "block" }} />
              </div>
